  ...
  "inline-flex cursor-pointer items-center gap-2 justify-center whitespace-nowrap rounded-full font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive hover:-translate-y-[2px]",
  {
    variants: {
      variant: {
        none: "",
        default:
          "bg-primary text-secondary-foreground shadow-[0_4px_12px_rgba(15,23,42,0.15)] hover:text-primary-blue hover:shadow-[0_8px_20px_rgba(15,23,42,0.25)]",
        defaultWithTextWhite:
          "bg-primary text-white shadow-[0_4px_12px_rgba(15,23,42,0.15)] hover:shadow-[0_8px_20px_rgba(15,23,42,0.25)]",
        primaryBlue:
