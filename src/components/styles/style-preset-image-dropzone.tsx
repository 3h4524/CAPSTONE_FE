    ...
    <div className="space-y-2">
      ...
      {previewUrl && (
        <div className="relative w-fit">
          <Image src={previewUrl} alt="Style preview" width={320} height={180} unoptimized className="aspect-video w-64 rounded-lg object-cover ring-1 ring-slate-200 ring-inset" />
          <Button
            type="button"
            variant="secondary"
            size="icon"
      ...
      <div
        className={cn(
          "flex min-h-20 items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 text-center transition-colors hover:border-slate-400",
